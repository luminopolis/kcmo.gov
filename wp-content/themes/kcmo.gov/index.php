<?php 
/*
Template Name: Has Side Slideshow
*/
get_header(); 
?>	
		<div id="body" class="withtabs">
			...
			<div id="content">
				...
				<?php if( $post->has_tabs ): ?>
					<div id="<?php echo kcmo_children_permalink_tab( $wp_query->current_post ); ?>" data-template="<?php echo kcmo_children_tab_template( $post->ID ); ?>">
				...
				<?php else: ?>
					<div id="">
						<div class="entry-content left-col">
							<h2 class="custom_heading"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
							<?php the_content(); ?>
							<?php edit_post_link(); ?>
						</div>
					</div>
